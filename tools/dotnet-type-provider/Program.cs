...
{
    stderr.WriteLine("Usage: dotnet-type-provider --namespace <namespace> --module-specifier <specifier> [--export <name>...] [--target-id <id>...] [--metadata-name <name>...] [--reference-dir <dir>] [--reference <assembly>]");
