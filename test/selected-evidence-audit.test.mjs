...
test("operation selection consumes atomic shared semantic decisions", () => {
  const required = new Map([
    ["src/policy/members/call-selection.ts", "getResolvedCallInfo"],
    ["src/policy/members/property-selection.ts", "getResolvedPropertyAccessInfo"],
    ["src/policy/members/element-selection.ts", "getResolvedElementAccessInfo"],
  ]);
  const violations = [];
