...
test("direct module helpers and array literals execute without delegate or staging-array owners", { timeout: 300_000 }, () => {
  ...
  writeFileSync(join(root, "Program.cs"), 'if (!Tsonic.Generated.Index.run() || !await Tsonic.Generated.Index.runAsync()) throw new System.Exception("allocation contract");');
