export const replacementContracts = Object.freeze({
  "provider-relations": contract(
    ...
    [
      "test/direct-provider-call-selection.test.mjs",
      "test/direct-provider-member-selection.test.mjs",
      "test/direct-provider-relations.test.mjs",
      "test/dotnet-provider.test.mjs",
      "../tsonic/test/cli-build/provider-dotnet-core.test.mjs",
    ],
  ),
  "contextual-translation": contract(
    `function identity<T>(value: T): T { return value; }\nconst value = identity<int32>(1);`,
    [
      "test/direct-translation-core.test.mjs",
      "test/direct-translation-artifacts.test.mjs",
      "../tsonic/test/cli-build/tsts-type-forms.test.mjs",
    ],
  ),
  bindings: contract(
    `const [head, ...tail] = values;\nconst { name, ...rest } = user;`,
    [
      "test/direct-translation-bindings.test.mjs",
      "test/direct-binding-projection-policy.test.mjs",
      "../tsonic/test/cli-build/arrays-destructuring-tuples.test.mjs",
      "../tsonic/test/cli-build/expressions-control-flow-binding-destructure.test.mjs",
    ],
  ),
  declarations: contract(
    `class Box<T> { constructor(readonly value: T) {} }\nclass TextBox extends Box<string> {}`,
    [
      "test/direct-translation-declarations.test.mjs",
      "test/direct-translation-inheritance-generics.test.mjs",
      "test/direct-translation-inheritance-constructors.test.mjs",
      "../tsonic/test/cli-build/modules-declarations-generics-interfaces.test.mjs",
    ],
  ),
  compat: contract(
    ...
    [
      "test/direct-translation-core.test.mjs",
      "../tsonic/test/cli-build/compat-runtime.test.mjs",
      "../tsonic/test/cli-build/expressions-control-flow-rejections.test.mjs",
    ],
  ),
  "js-surface": contract(
    `const values = [1, 2].map((value) => value + 1);\nconsole.log(JSON.stringify(values));`,
    [
      "../tsonic/test/cli-build/js-surface-arrays.test.mjs",
      "../tsonic/test/cli-build/js-surface-math-console-json.test.mjs",
      "../tsonic/test/cli-build/js-surface-number-boolean.test.mjs",
      "../tsonic/test/cli-build/js-surface-objects-records-iteration.test.mjs",
      "../tsonic/test/cli-build/js-surface-strings-regexp-date.test.mjs",
      "../tsonic/test/cli-build/js-surface-rejections.test.mjs",
    ],
  ),
  "object-shapes": contract(
    ...
    [
      "test/direct-translation-core.test.mjs",
      "../tsonic/test/cli-build/object-shapes-basic.test.mjs",
      "../tsonic/test/cli-build/object-shapes-generated-carriers.test.mjs",
      "../tsonic/test/cli-build/object-shapes-spread-record.test.mjs",
      "../tsonic/test/cli-build/object-shapes-rejections.test.mjs",
    ],
  ),
  "operators-control": contract(
    `values[index++] += next();\nfor (const value of values) { if (value > 0) break; }`,
    [
      "../tsonic/test/cli-build/expressions-control-flow-expressions.test.mjs",
      "../tsonic/test/cli-build/expressions-control-flow-functions-this-async.test.mjs",
      "../tsonic/test/cli-build/expressions-control-flow-statements.test.mjs",
      "../tsonic/test/cli-build/e2e-runtime-language-nullish-flow.test.mjs",
    ],
  ),
  iteration: contract(
    ...
    [
      "test/direct-translation-core.test.mjs",
      "../tsonic/test/cli-build/iteration-facts.test.mjs",
      "../tsonic/test/cli-build/js-surface-objects-records-iteration.test.mjs",
    ],
  ),
  "source-core": contract(
    ...
    [
      "test/direct-source-core-translation.test.mjs",
      "test/direct-translation-core.test.mjs",
      "test/dotnet-provider-attributes.test.mjs",
      "../tsonic/test/cli-build/source-semantics.test.mjs",
      "../tsonic/test/cli-build/provider-dotnet-delegates-attributes-exceptions.test.mjs",
    ],
  ),
  "types-conversions": contract(
    `const dog = animal as Dog;\nconst value: string | int32 = condition ? "x" : 1;`,
    [
      "test/direct-source-literal-policy.test.mjs",
      "test/direct-translation-core.test.mjs",
      "test/direct-translation-declarations.test.mjs",
      "test/dotnet-provider-generic-constraints.test.mjs",
      "../tsonic/test/cli-build/provider-dotnet-constraints-conversions.test.mjs",
      "../tsonic/test/cli-build/runtime-union.test.mjs",
    ],
  ),
  "source-profiles": contract(
    `const clr = path.Split("/");\nconst js = path.split("/");`,
    [
      "test/source-profile-contract.test.mjs",
      "../tsonic/test/cli-build/source-profile-contract.test.mjs",
      "../tsonic/test/cli-build/js-surface-rejections.test.mjs",
    ],
  ),
  diagnostics: contract(
    ...
    [
      "test/direct-translation-core.test.mjs",
      "test/native-product-boundary.test.mjs",
      "../tsonic/test/cli-build/expressions-control-flow-rejections.test.mjs",
      "../tsonic/test/cli-build/provider-dotnet-rejections.test.mjs",
    ],
  ),
  "deleted-target-fact-architecture": contract(
    `const parts = path.Split("/");\nConsole.WriteLine(parts.Length);`,
    [
      "test/analysis-abstraction-policy.test.mjs",
      "test/selected-evidence-audit.test.mjs",
      "test/direct-translation-core.test.mjs",
      "../tsonic/test/architecture-contract.test.mjs",
      "../tsonic/test/selected-evidence-audit.test.mjs",
    ],
  ),
});
