...
export const expectedSharedSourceQuerySites = Object.freeze(new Map([
  ...
  ...querySite("src/backend/planner/statement-try.ts", "source-query.getSymbolAtLocation", 1, "Resolve the exact checked catch binding symbol."),
  ...
  ...querySite("src/backend/planner/binding-state.ts", "source-query.getSymbolAtLocation", 1, "Resolve an exact checked binding symbol."),
  ...querySite("src/backend/planner/binding-state.ts", "source-query.getResolvedSymbol", 1, "Resolve an exact checked binding alias."),
