...
export const analysisAbstractionDebtCatalog = Object.freeze([
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/policy.ts", { "target-member-table": 10, "source-library-member-id-type": 3 }, "surface-policy-candidate", "surface-provider", "Keep current concrete target member policy data cataloged while moving target mappings to provider metadata registries."),
