...
export const analysisAbstractionDebtCatalog = Object.freeze([
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/console.ts", { "source-member-declaring-name": 1, "source-member-name": 1, "target-member-helper": 1 }, "provider-metadata-candidate", "surface-provider", "Map console through selected JS surface policy and provider metadata."),
  entry("src/source/csharp-source-semantics/surfaces/js/collection-target-metadata.ts", { "target-member-helper": 2, "target-member-table": 1 }, "provider-metadata-candidate", "surface-provider", "Collection target metadata is isolated; next step is replacing inline target member construction with provider metadata records."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/properties.ts", { "source-member-name": 1, "source-library-member-read": 2 }, "surface-policy-candidate", "surface-provider", "Property handling must consume property policy facts, not inspect source names directly."),
  entry("src/source/csharp-source-semantics/surfaces/js/property-policy.ts", { "target-member-helper": 2, "target-member-table": 1 }, "surface-policy-candidate", "surface-provider", "Convert property policy target members to provider metadata."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/unsupported.ts", { "source-member-declaring-name": 2 }, "surface-policy-candidate", "surface-provider", "Unsupported-member diagnostics must key off selected identities and lane classifications."),
