...
export const analysisAbstractionDebtCatalog = Object.freeze([
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/policy.ts", { "source-library-member-id-type": 3 }, "surface-policy-candidate", "surface-provider", "Keep current concrete target member policy data cataloged while moving target mappings to provider metadata registries."),
