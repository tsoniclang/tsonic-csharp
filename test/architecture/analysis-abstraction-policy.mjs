...
export const analysisAbstractionDebtCatalog = Object.freeze([
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/json.ts", { "source-library-member-read": 1, "target-member-helper": 1, "target-member-table": 1 }, "explicit-exception-candidate", "surface-provider", "JSON stringify/parse policies must be explicit exceptions with selected source identity and provider facts."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/policy.ts", { "target-member-table": 18 }, "surface-policy-candidate", "surface-provider", "Keep current concrete target member policy data cataloged while moving target mappings to provider metadata registries."),
