...
export const analysisAbstractionDebtCatalog = Object.freeze([
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/booleans.ts", { "target-member-helper": 1, "target-member-table": 1, "source-name-switch": 1 }, "provider-metadata-candidate", "surface-provider", "Represent JS Boolean members as provider metadata or explicit exceptions."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/console.ts", { "target-member-helper": 1 }, "provider-metadata-candidate", "surface-provider", "Map console target members through provider metadata."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/date.ts", { "target-member-helper": 3, "target-member-table": 1, "source-name-branch": 1 }, "explicit-exception-candidate", "surface-provider", "Date call/new differences must be explicit exceptions with provider target metadata."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/json.ts", { "source-library-member-read": 1, "source-member-id-optional-branch": 1, "target-member-helper": 1, "target-member-table": 1, "source-name-switch": 1 }, "explicit-exception-candidate", "surface-provider", "JSON stringify/parse policies must be explicit exceptions with selected source identity and provider facts."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/numbers.ts", { "target-member-helper": 3, "target-member-table": 1, "source-name-switch": 1 }, "provider-metadata-candidate", "surface-provider", "Represent Number members as provider metadata or explicit exceptions."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/policy.ts", { "target-member-table": 18, "source-library-member-id-type": 3 }, "surface-policy-candidate", "surface-provider", "Keep current concrete target member policy data cataloged while moving target mappings to provider metadata registries."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/property-policy.ts", { "target-member-helper": 2, "target-member-table": 1, "source-library-declaring-name-type": 2, "source-library-member-id-type": 5 }, "surface-policy-candidate", "surface-provider", "Convert property policy target members to provider metadata."),
  entry("src/source/csharp-source-semantics/surfaces/js/regexp.ts", { "target-member-helper": 4, "target-member-table": 1, "source-name-branch": 2, "source-name-switch": 1 }, "provider-metadata-candidate", "surface-provider", "Represent RegExp operations as provider metadata or explicit exceptions."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/strings.ts", { "target-member-helper": 3, "target-member-table": 1, "source-name-branch": 3, "source-name-switch": 2 }, "provider-metadata-candidate", "surface-provider", "Represent String members as provider metadata or explicit exceptions."),
