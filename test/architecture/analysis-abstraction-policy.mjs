...
export const analysisAbstractionDebtCatalog = Object.freeze([
  ...
  entry("src/source/csharp-source-semantics/object-shape-semantic-facts.ts", { "source-library-type-check": 2 }, "object-shape-classification-candidate", "target-provider", "Use type-classification facts to exclude provider/source-library carriers from object-shape lowering."),
  entry("src/source/csharp-source-semantics/operations-provider.ts", { "source-library-type-check": 2, "source-library-member-read": 2 }, "source-identity-policy-candidate", "target-provider", "Replace direct library probing with selected source identity and provider policy facts."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/array-carriers.ts", { "source-library-type-check": 2, "source-library-member-read": 1 }, "surface-policy-candidate", "surface-provider", "Move array carrier decisions to selected source identities and carrier policies."),
  entry("src/source/csharp-source-semantics/surfaces/js/arrays/element-access.ts", { "source-library-type-check": 2 }, "surface-policy-candidate", "surface-provider", "Use array source identity facts and target indexer facts for element access."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/collections.ts", { "source-member-declaring-name": 3, "source-member-name": 2, "source-library-type-check": 1, "target-member-helper": 2, "target-member-table": 1 }, "provider-metadata-candidate", "surface-provider", "Move collection member tables to provider metadata and selected member policy facts."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/date.ts", { "source-library-type-check": 1, "target-member-helper": 3, "target-member-table": 1 }, "explicit-exception-candidate", "surface-provider", "Date call/new differences must be explicit exceptions with provider target metadata."),
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/property-policy.ts", { "source-member-declaring-name": 15, "source-member-name": 14, "source-library-type-check": 1, "target-member-helper": 2, "target-member-table": 1 }, "surface-policy-candidate", "surface-provider", "Convert property policy entries to selected declaration identity plus provider metadata."),
  entry("src/source/csharp-source-semantics/surfaces/js/regexp.ts", { "source-library-type-check": 1, "target-member-helper": 4, "target-member-table": 1 }, "provider-metadata-candidate", "surface-provider", "Represent RegExp operations as provider metadata or explicit exceptions."),
  ...
  entry("src/source/csharp-source-semantics/target-type-reference-syntax.ts", { "source-library-type-check": 1 }, "type-classification-candidate", "target-provider", "Use source type classification facts to render target type references."),
  entry("src/source/csharp-source-semantics/target-type-semantic-resolution.ts", { "source-library-type-check": 4 }, "type-classification-candidate", "target-provider", "Replace source-library type branches with target type policy facts."),
