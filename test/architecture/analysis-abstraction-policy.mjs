...
export const analysisAbstractionDebtCatalog = Object.freeze([
  ...
  entry("src/source/csharp-source-semantics/surfaces/js/collections.ts", { "source-member-declaring-name": 3, "source-member-name": 2, "target-member-helper": 2, "target-member-table": 1 }, "provider-metadata-candidate", "surface-provider", "Move collection member tables to provider metadata and selected member policy facts."),
