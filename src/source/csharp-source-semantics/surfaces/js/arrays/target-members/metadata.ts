...
export function arrayTargetMemberMetadata(receiverElementType?: TargetTypeRef): readonly JsSurfaceTargetMemberMetadata[] {
  ...
  return [
    ...
    ...(receiverElementType === undefined ? [] : arrayAtHelpers("at", "at", context.readOnlyListType, context.itemType, context.doubleType, context.arrayHelpersType)),
    ...(receiverElementType === undefined ? [] : arrayAtHelpers("at", "at:full-js", context.arrayType, context.itemType, context.doubleType, context.arrayHelpersType)),
